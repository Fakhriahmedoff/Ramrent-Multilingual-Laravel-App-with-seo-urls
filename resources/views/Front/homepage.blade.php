...
<div id="page-content">
    <div class="swiper-container homepage">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" style="background-image:
                url('/front/images/second.jpg'); background-size: cover;">
                <div class="section-breadcrumb">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="swiper-slide" style="background-image:
                url('/front/images/third.jpg'); background-size: cover;">
                <div class="section-breadcrumb">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="swiper-slide" style="background-image:
                url('/front/images/fourth.jpg'); background-size: cover;">
                <div class="section-breadcrumb">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="swiper-slide" style="background-image:
                url('/front/images/fifth.jpg'); background-size: cover;">
                <div class="section-breadcrumb">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="splide__track">
                    <ul class="splide__list">
                        <li class="splide__slide"><img
                                src="/front/images/image.png" alt=""></li>
                        <li class="splide__slide"><img
                                src="/front/images/image.png" alt=""></li>
                        <li class="splide__slide"><img
                                src="/front/images/image.png" alt=""></li>
